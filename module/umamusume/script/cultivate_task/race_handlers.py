...
from module.umamusume.constants.timing_constants import DIALOG_WAIT, SCROLL_DELAY, RECOVERY_DELAY
    ...
    if goal_match:
        ...
        if ctx.cultivate_detail.turn_info.turn_operation.turn_operation_type == TurnOperationType.TURN_OPERATION_TYPE_RACE:
            ...
            while True:
                ...
                swiped = True
            # Re-capture after scrolling to top so find_race gets a fresh frame
